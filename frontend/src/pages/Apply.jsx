...
const roleCopy = {
  agent: {
    ...
    subtitle: "Tell us a bit about yourself. The hiring manager will review your application.",
  },
  manager: {
    title: "Apply as a Manager",
    subtitle: "Tell us about your experience. The hiring manager will review your application.",
  },
};

const Apply = () => {
  const { role } = useParams(); // "agent" | "manager"
  const copy = roleCopy[role] || roleCopy.agent;

  const [form, setForm] = useState({
    orgSlug: "", name: "", email: "", password: "", department: "", experience: "",
  });
        ...
        {submitted ? (
          <>
            ...
            <Alert severity="success" sx={{ borderRadius: 2, mb: 2 }}>
              The hiring manager will review it soon. You'll be able to sign in with the password you set once it's approved.
            </Alert>
          ...
          <>
            ...
            <Box component="form" onSubmit={handleSubmit} sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              ...
              />
              <TextField
                label={role === "manager" ? "Relevant experience" : "Skills or past experience"}
                name="experience"
